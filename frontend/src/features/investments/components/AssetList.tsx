          ...
          <CardContent className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div>
                ...
                <p className="font-medium">{formatCurrency(asset.investedAmount)}</p>
              </div>
              <div>
                <span className="text-muted-foreground">Valor atual</span>
                <p className="font-medium">
                  {asset.currentValue !== null ? formatCurrency(asset.currentValue) : 'Não informado'}
                </p>
              </div>
            </div>
            ...
            {asset.profitabilityAmount !== null && asset.profitabilityPercentage !== null ? (
              ...
              >
                ...
                {formatCurrency(asset.profitabilityAmount)} ({asset.profitabilityPercentage.toFixed(2)}%)
              </p>
            ) : (
